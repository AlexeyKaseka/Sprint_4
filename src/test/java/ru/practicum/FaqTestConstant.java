...
public class FaqTestConstant {
    ...
    public static final int QUESTION_INDEX_4 = 3;
    public static final int QUESTION_INDEX_5 = 4;
    public static final int QUESTION_INDEX_6 = 5;
    public static final int QUESTION_INDEX_7 = 6;
    public static final int QUESTION_INDEX_8 = 7;
    // Текст вопроса
